 ...
 * create-neptune-app
 *
 * Placeholder CLI whose main purpose is to reserve the "create-neptune-app"
 * name on npm and document the intended behavior.
 */
...
For now, this CLI is a non-functional placeholder that simply describes the intent.
`;
